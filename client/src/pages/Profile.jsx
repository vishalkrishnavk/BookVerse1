...
import { fetchPosts, getUserInfo, likePost, deletePost } from "../utils";
  ...
  return (
    <>
      <div className="home w-full px-0 lg:px-10 pb-20 2xl:px-40 bg-bgColor lg:rounded-lg h-screen overflow-hidden">
        <div className="w-full flex gap-2 lg:gap-4 md:pl-4 pt-5 pb-10 h-[calc(100vh-80px)] overflow-hidden">
          {/* LEFT */}
          ...
          {/* RIGHT */}
          <div className="hidden lg:flex w-1/4 flex-col gap-4 overflow-y-auto">
            <FriendsCard friends={userInfo?.friends} />
            <Sidebar ProfileData={userInfo} />
          </div>
        </div>
      </div>
    </>
